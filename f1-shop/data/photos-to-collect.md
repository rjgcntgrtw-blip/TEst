...
### https://www.aliexpress.us/item/3256812754900173.html

| slug | Вариант в лоте | Товар |
|---|---|---|
| `merch-ferrari-cap-monza-2025` | цвет и размер покупателя | Кепка Ferrari «Монца» — Реплика командной формы · 2025 |
...
### https://www.aliexpress.us/item/3256812338009231.html

| slug | Вариант в лоте | Товар |
|---|---|---|
| `merch-ferrari-tee-16-2026` | цвет и размер покупателя | Футболка Ferrari · Леклер 16 — Реплика командной формы · 2026 |

### https://www.aliexpress.us/item/3256812750242513.html

| slug | Вариант в лоте | Товар |
|---|---|---|
| `merch-ferrari-tee-2026` | цвет и размер покупателя | Футболка Ferrari — Реплика командной формы · 2026 |
...
### https://www.aliexpress.us/item/3256812758705689.html

| slug | Вариант в лоте | Товар |
|---|---|---|
| `merch-ferrari-tee-monza-2025` | цвет и размер покупателя | Футболка Ferrari «Монца» — Реплика командной формы · 2025 |
...
### https://www.aliexpress.us/item/3256808663430353.html

| slug | Вариант в лоте | Товар |
|---|---|---|
| `merch-mercedes-cap-44-2024` | цвет и размер покупателя | Кепка Mercedes · Хэмилтон 44 — Реплика командной формы · 2024 |
...
### https://www.aliexpress.us/item/3256811449048467.html

| slug | Вариант в лоте | Товар |
|---|---|---|
| `merch-mercedes-tee-12-2026` | цвет и размер покупателя | Футболка Mercedes · Антонелли 12 — Реплика командной формы · 2026 |
...
### https://www.aliexpress.us/item/3256805874195736.html

| slug | Вариант в лоте | Товар |
|---|---|---|
| `merch-redbull-cap-11-2024` | цвет и размер покупателя | Кепка Red Bull Racing · Перес 11 — Реплика командной формы · 2024 |

### https://www.aliexpress.us/item/3256812628966029.html

| slug | Вариант в лоте | Товар |
|---|---|---|
| `merch-redbull-longsleeve-11-2024` | цвет и размер покупателя | Лонгслив Red Bull Racing · Перес 11 — Реплика командной формы · 2024 |
